...
При работе обращайся к файлам:
- references/fstek-workflow.md
- references/fstek-model-structure.md
- references/negative-consequences.md
- references/impact-objects.md
- references/threat-sources.md
- references/threat-realization-methods.md
- references/threat-actuality-rules.md
- references/attacker-capabilities.md
- references/bdu-usage.md

## Результат

Формируй результат по шаблонам из assets:
- assets/system-description-template.md
- assets/threat-model-report-template.md
- assets/threat-register-template.md
- assets/actuality-assessment-table.md
